...
export const MESSAGE_CATALOG = {
  ...
  "doc.gap.advisor_not_available": {
    en: "Azure Advisor answered and named no recommendation for this resource.",
    id: "Azure Advisor menjawab namun tidak menyebutkan rekomendasi apa pun untuk sumber daya ini.",
  },
