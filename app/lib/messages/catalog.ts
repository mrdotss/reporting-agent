...
export const MESSAGE_CATALOG = {
  ...
  "ui.run_form.front_matter_hint": {
    en: "This report profile renders a cover and a document-control page, so a run needs a customer name and a revision row. They are printed in the document and are not collected from Azure.",
    id: "Profil laporan ini menghasilkan halaman sampul dan halaman kendali dokumen, sehingga proses memerlukan nama pelanggan dan baris revisi. Keduanya dicetak di dokumen dan tidak dikumpulkan dari Azure.",
  },
