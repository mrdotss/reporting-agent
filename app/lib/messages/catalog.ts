...
export const MESSAGE_CATALOG = {
  ...
  "ui.run_form.no_templates_hint": {
    en: "You have no templates. The three starters are created with your account; if none is listed, author one in the wizard.",
    id: "Anda tidak memiliki templat. Tiga templat awal dibuat bersama akun Anda; jika tidak ada yang tercantum, buat satu di wizard.",
  },
  "ui.run_form.no_template_versions_hint": {
    en: "None of your templates has a saved version yet. A template gets its first version when the wizard's last step completes.",
    id: "Belum ada templat Anda yang memiliki versi tersimpan. Templat mendapat versi pertamanya saat langkah terakhir wizard selesai.",
  },
