...
export const MESSAGE_CATALOG = {
  ...
  "doc.front_matter.revision": {
    en: "Revision",
    id: "Revisi",
  },
  "doc.front_matter.revision_author": {
    en: "Issued by",
    id: "Diterbitkan oleh",
  },
  "doc.front_matter.revision_note": {
    en: "Note",
    id: "Keterangan",
  },
  ...
  "doc.section.postgresql_flexible_inventory": {
  ...
  "doc.table.attr.resource_group": {
    en: "Resource group",
    id: "Grup sumber daya",
  },
  "doc.table.attr.resource_type": {
    en: "Resource type",
    id: "Jenis sumber daya",
  },
  "doc.table.attr.location": {
    en: "Location",
    id: "Lokasi",
  },
  ...
  "ui.gap_label.advisor_not_available": {
    en: "Advisor unavailable",
    id: "Advisor tidak tersedia",
  },
  "ui.gap_label.archive_write_failed": {
    en: "Archive write failed",
    id: "Penulisan arsip gagal",
  },
  "ui.gap_label.backup_not_configured": {
    en: "Backup not configured",
    id: "Pencadangan belum dikonfigurasi",
  },
  "ui.gap_label.catalog_entry_invalid": {
    en: "Catalogue entry invalid",
    id: "Entri katalog tidak valid",
  },
  "ui.gap_label.deallocated": {
    en: "Virtual machine deallocated",
    id: "Mesin virtual dinonaktifkan",
  },
  "ui.gap_label.definitions_unavailable": {
    en: "Metric definitions unavailable",
    id: "Definisi metrik tidak tersedia",
  },
  "ui.gap_label.duplicate_inventory_row": {
    en: "Duplicate inventory row",
    id: "Baris inventaris ganda",
  },
  "ui.gap_label.fact_unavailable": {
    en: "Fact unavailable",
    id: "Fakta tidak tersedia",
  },
  "ui.gap_label.instance_name_collapsed": {
    en: "Instance names collapsed",
    id: "Nama instans digabungkan",
  },
  "ui.gap_label.interval_counts_missing": {
    en: "Interval counts missing",
    id: "Jumlah interval tidak ada",
  },
  "ui.gap_label.interval_malformed": {
    en: "Interval malformed",
    id: "Format interval salah",
  },
  "ui.gap_label.metric_error": {
    en: "Metric returned an error",
    id: "Metrik mengembalikan galat",
  },
  "ui.gap_label.metric_not_emitted": {
    en: "Metric not emitted",
    id: "Metrik tidak dikirim",
  },
  "ui.gap_label.metric_not_selected": {
    en: "No metric selected",
    id: "Tidak ada metrik dipilih",
  },
  "ui.gap_label.no_reservations": {
    en: "No reservations found",
    id: "Tidak ada reservasi ditemukan",
  },
  ...
  "ui.gap_label.percentile_unsupported_unit": {
    ...
    id: "Persentil tidak didukung untuk satuan ini",
  },
  "ui.gap_label.permission_denied": {
    en: "Permission denied",
    id: "Akses ditolak",
  },
  "ui.gap_label.power_state_unknown": {
    en: "Power state unknown",
    id: "Status daya tidak diketahui",
  },
  "ui.gap_label.region_unreachable": {
    en: "Region unreachable",
    id: "Region tidak dapat dijangkau",
  },
  "ui.gap_label.replication_not_enabled": {
    en: "Replication not enabled",
    id: "Replikasi tidak diaktifkan",
  },
  "ui.gap_label.resource_absent_from_response": {
    en: "Resource absent from response",
    id: "Sumber daya tidak ada dalam respons",
  },
  "ui.gap_label.response_too_large": {
    en: "Response too large",
    id: "Respons terlalu besar",
  },
  "ui.gap_label.sku_capability_missing": {
    en: "SKU capability missing",
    id: "Kapabilitas SKU tidak ada",
  },
  "ui.gap_label.sku_unknown": {
    en: "SKU unknown",
    id: "SKU tidak dikenal",
  },
  "ui.gap_list.unrecognized": {
    en: "Unrecognised gap type",
    id: "Jenis celah tidak dikenal",
  },
  ...
  "doc.historical.monthly_statement": {
    en: "Historical trend: {count} of {requested} requested calendar months measured. Months without measurements are not plotted.",
    id: "Tren historis: {count} dari {requested} bulan kalender yang diminta telah diukur. Bulan tanpa pengukuran tidak diplot.",
  },
  "doc.historical.monthly_verification_note": {
    en: "Monthly values come from this report's collected snapshot and are checked against its figure ledger.",
    id: "Nilai bulanan berasal dari snapshot yang dikumpulkan untuk laporan ini dan diperiksa terhadap buku besar angkanya.",
  },
  ...
  "ui.run_form.provider_presets": {
    en: "Showing {provider} presets, the source this connector reads.",
    id: "Menampilkan preset {provider}, sumber yang dibaca konektor ini.",
  },
  "ui.run_form.no_provider_presets": {
    en: "No {provider} preset yet. A preset is written for one source, so create one for {provider} first.",
    id: "Belum ada preset {provider}. Preset ditulis untuk satu sumber, jadi buat preset untuk {provider} terlebih dahulu.",
  },
  ...
  "ui.run_phases.complete": {
    en: "Complete",
    id: "Selesai",
  },
  "ui.run_phases.in_progress": {
    en: "In progress",
    id: "Sedang berjalan",
  },
  "ui.run_phases.pending": {
    en: "Pending",
    id: "Menunggu",
  },
  "ui.request_details.heading": {
    en: "Request details",
    id: "Rincian permintaan",
  },
  "ui.request_details.connection": {
    en: "Connection",
    id: "Koneksi",
  },
  "ui.request_details.profile": {
    en: "Profile",
    id: "Profil",
  },
  "ui.request_details.period": {
    en: "Period",
    id: "Periode",
  },
  "ui.request_details.timezone": {
    en: "Timezone",
    id: "Zona waktu",
  },
  "ui.request_details.output": {
    en: "Output",
    id: "Keluaran",
  },
  "ui.request_details.output_value": {
    en: "DOCX and PDF",
    id: "DOCX dan PDF",
  },
  "ui.request_details.not_pinned": {
    en: "Not pinned",
    id: "Tidak disematkan",
  },
  "ui.request_details.version": {
    en: "version",
    id: "versi",
  },
  ...
  "ui.verification.passed_not_delivered": {
    en: "The run did not finish, so no document was produced and none is offered for download. These checks describe the figures that were compiled before it stopped.",
    id: "Proses tidak selesai, sehingga tidak ada dokumen yang dihasilkan dan tidak ada yang ditawarkan untuk diunduh. Pemeriksaan ini menjelaskan angka yang dikompilasi sebelum proses berhenti.",
  },
