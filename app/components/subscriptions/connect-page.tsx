...
/**
 * The onboarding wizard's page body (Requirements 11.3–11.7, 11.9, 11.10, 12.7), rendered
 * by `/subscriptions/new` once it has checked who may connect.
 *
 * No `"use client"` anywhere in it. It composes two things and does no work of its own:
 *
 ...
 *   * the render instant, as ISO 8601 (`nowIso`). The wizard states the accepted expiry
 *     range and validates against it, and both have to be the same instant — a
