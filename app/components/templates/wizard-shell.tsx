...
export function WizardShell({
  ...
  // `initialDefinition` arrives ALREADY LIFTED to v3 — the page's loader applies
  // `openingDraft` server-side (Requirement 20.1). It is not lifted here, and must not
  // be: the lifter reads the section catalogue, which is `server-only`, and this is the
  // one `"use client"` boundary on the screen.
