...
SYSTEM_PROMPT_TREND: Final[str] = (
    ...
    "about causes you cannot see in the data. Available Memory is memory available "
    "for use, not memory used. Without total memory or a memory-used percentage, "
    "do not infer light utilization or ample headroom from available memory alone.\n"
    "\n"
    "Return prose only: no headings, no bullet lists, no markdown."
)
...
SYSTEM_PROMPT_TREND_ID: Final[str] = (
    ...
    "penyebab yang tidak dapat Anda lihat dalam data. Available Memory adalah memori "
    "yang tersedia, bukan memori yang digunakan. Tanpa total memori atau persentase "
    "memori terpakai, jangan menyimpulkan pemanfaatan ringan atau kapasitas longgar "
    "dari memori tersedia saja. Bedakan CPU dan memori secara jelas.\n"
    "\n"
    "Kembalikan prosa saja: tanpa heading, tanpa bullet list, tanpa markdown."
)
...
SYSTEM_PROMPT_RESOURCE: Final[str] = (
    ...
    "speculate about causes you cannot see in the data. Available Memory is memory "
    "available for use, not memory used. Without total memory or a memory-used "
    "percentage, do not infer light utilization or ample headroom from available "
    "memory alone. Distinguish CPU and memory explicitly.\n"
    "\n"
    "Return prose only: no headings, no bullet lists, no markdown."
)
...
def _system_prompt_for(
    ...
    # The no-ai-slop word and pattern lists, subordinate to the figure rules above them.
