...
def test_the_declared_gap_type_partition_holds_exactly_twenty_five_values() -> None:
    ...
    added, because a count is satisfied by any five strings. Task 6.4 adds the fifth —
    `advisor_not_available` — to the same set task 1 originally declared with four."""
